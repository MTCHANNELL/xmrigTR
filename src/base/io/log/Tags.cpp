...
{
    static const char *tag = CYAN_BG_BOLD(WHITE_BOLD_S "--AYARLAR-");
...
{
    static const char *tag = BLUE_BG_BOLD(WHITE_BOLD_S "--YENi iŞ-");
...
{
    static const char* tag = YELLOW_BG_BOLD(WHITE_BOLD_S "---KAYNAK-");
...
{
    static const char *tag = CYAN_BG_BOLD(WHITE_BOLD_S "-iŞLEMLER-");
...
{
    static const char *tag = GREEN_BG_BOLD(WHITE_BOLD_S "-----SIRA-");
...
{
    static const char *tag = MAGENTA_BG_BOLD(WHITE_BOLD_S "----VEKiL-");
