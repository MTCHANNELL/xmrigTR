...
#   endif
    ...
    Log::print(GREEN_BOLD(" * ") WHITE_BOLD("%-13s") CYAN_BOLD("%s/%s") WHITE_BOLD(" %s"), "HAKKINDA          :", APP_NAME, APP_VERSION, buf);
...
#   endif
    ...
    Log::print(GREEN_BOLD(" * ") WHITE_BOLD("%-13sLiBUV:%s %s"), "KüTüPHANELER      :", uv_version_string(), libs.c_str());
}
